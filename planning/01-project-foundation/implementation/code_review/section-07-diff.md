...
+  },
+);
diff --git a/apps/desktop/src/index.html b/apps/desktop/index.html
similarity index 72%
rename from apps/desktop/src/index.html
rename to apps/desktop/index.html
index fedb366..a981d95 100644
...
+
+export default App;
diff --git a/apps/desktop/src/__tests__/App.test.tsx b/apps/desktop/src/__tests__/App.test.tsx
new file mode 100644
index 0000000..bb48e7f
--- /dev/null
+++ b/apps/desktop/src/__tests__/App.test.tsx
@@ -0,0 +1,37 @@
...
new file mode 100644
index 0000000..e45d1f9
--- /dev/null
+++ b/apps/desktop/src/__tests__/setup.ts
@@ -0,0 +1,6 @@
+import "@testing-library/jest-dom/vitest";
+
+// Mock the Tauri IPC layer so tests don't attempt real IPC calls
