...
index 62ecdf9..1fafaa0 100644
--- a/apps/desktop/src-tauri/src/db.rs
+++ b/apps/desktop/src-tauri/src/db.rs
@@ -8,9 +8,107 @@ fn configure_connection(conn: &Connection) -> Result<()> {
     )
 }
...
+        assert!(count > 0, "tables should still exist");
+    }
+
+    #[test]
