...
Generate content for section `section-04-postgres-migrations` (filename: `section-04-postgres-migrations.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/nisar/personal/projects/openconv/planning/01-project-foundation/claude-plan.md` - Full implementation plan
2. `/Users/nisar/personal/projects/openconv/planning/01-project-foundation/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-postgres-migrations` to understand what this section should contain.
...
`/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/section-04-postgres-migrations.md`
