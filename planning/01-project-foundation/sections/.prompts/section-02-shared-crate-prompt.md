...
Generate content for section `section-02-shared-crate` (filename: `section-02-shared-crate.md`).
...
for `section-02-shared-crate` to understand what this section should contain.
...
`/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/section-02-shared-crate.md`
