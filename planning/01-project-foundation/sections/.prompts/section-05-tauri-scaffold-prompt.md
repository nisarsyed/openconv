...
Generate content for section `section-05-tauri-scaffold` (filename: `section-05-tauri-scaffold.md`).
...
for `section-05-tauri-scaffold` to understand what this section should contain.
...
`/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/section-05-tauri-scaffold.md`
