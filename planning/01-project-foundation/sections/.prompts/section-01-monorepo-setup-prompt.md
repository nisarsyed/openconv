...
Generate content for section `section-01-monorepo-setup` (filename: `section-01-monorepo-setup.md`).
...
for `section-01-monorepo-setup` to understand what this section should contain.
...
`/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/section-01-monorepo-setup.md`
