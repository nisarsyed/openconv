...
Generate content for section `section-03-server-scaffold` (filename: `section-03-server-scaffold.md`).
...
for `section-03-server-scaffold` to understand what this section should contain.
...
`/Users/nisar/personal/projects/openconv/planning/01-project-foundation/sections/section-03-server-scaffold.md`
