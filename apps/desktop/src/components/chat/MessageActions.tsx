...
export function MessageActions({
  ...
  return (
    <div
      className="animate-fade-in absolute -top-3 right-4 flex items-center gap-0.5 rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-popover)] p-0.5 shadow-[var(--shadow-md)]"
      data-testid="message-actions"
    >
      <button
        aria-label="Reply"
        className="rounded-md p-1 text-[var(--text-muted)] transition-colors hover:bg-[var(--interactive-hover)] hover:text-[var(--text-primary)]"
      >
