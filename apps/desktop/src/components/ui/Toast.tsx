...
export function Toast({ notification, onDismiss }: ToastProps) {
  ...
  return (
    <div
      className={`flex animate-[slideIn_0.3s_ease-out] items-center gap-2 rounded-lg border px-3.5 py-2.5 text-sm text-[var(--text-primary)] shadow-[var(--shadow-lg)] backdrop-blur-sm ${typeStyles[notification.type]}`}
    >
